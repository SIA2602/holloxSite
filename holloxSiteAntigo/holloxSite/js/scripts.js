...
{  
  ...
  document.getElementById('Pg0401').innerHTML = "A hollox traz agilidade </br>nos processos e <span class='text-muted'>ganho </br>na produtividade</span>";
...
{  
  ...
  document.getElementById('Pg0201').innerHTML = "Mixed Reality applications make <span class='text-muted'> </br>it possible </span>";  
  ...
  document.getElementById('Pg0401').innerHTML = "The user can work hands-free </br>and still has <span class='text-muted'> access to </br>real-time data and experts.</span>";
